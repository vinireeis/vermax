...
class GetTokenUseCase(IGetTokenUseCase):
    ...
    async def get_token(
        ...
        try:
            ...
            cls.verify_password_is_valid(
                user_entity=user_entity, password=form_data.password
            )
    ...
    @staticmethod
    def verify_password_is_valid(user_entity: UserEntity, password: str):
        return user_entity.validate_password(password=password)
